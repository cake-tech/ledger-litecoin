...
Future<String> getTrustedInput(
  ...
  Future<Uint8List> processScriptBlocks(
    ...
    for (final scriptBlock in scriptBlocks) {
      res = await ledger.sendOperation(
          device, LitecoinGetTrustedInputOperation(scriptBlock),
  ...
  for (final input in transaction.inputs) {
    ...
    await ledger.sendOperation(device, LitecoinGetTrustedInputOperation(data),
        transformer: transformer);
